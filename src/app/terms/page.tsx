        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="mb-8">
            ...
            <p className="text-xl text-slate-600 mb-8">
              Stiamo preparando i nostri termini di servizio per garantire trasparenza e chiarezza.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bg-white border border-slate-200 rounded-2xl p-12 text-center shadow-lg">
            ...
            <p className="text-lg text-slate-600 mb-8 leading-relaxed">
              Stiamo lavorando sui nostri termini di servizio per definire chiaramente i diritti e doveri 
              di tutti gli utenti della piattaforma. Nel frattempo, puoi contattarci per qualsiasi domanda.
            </p>
